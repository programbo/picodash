...
- Create a native typed Picodash Store as the authoritative state for one monitoring Panel.
...
- Update the local README with install, run, Store, exposure, and verification notes.
