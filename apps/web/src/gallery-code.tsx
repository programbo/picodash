...
export function GalleryCode() {
  const {
    ...
    setProviderTheme: onProviderThemeChange,
    themes,
  } = useDemoContext()
  const providerTheme = themes.provider ?? 'dark'
            ...
            <code className="block min-w-max">
              ...
              <CodeLine indent={1}>
                ...
                <InlineSelect
                  ...
                  value={providerTheme}
                  values={['dark', 'light', 'ocean', 'plum', 'cyber', 'contrast']}
              ...
              <CodeLine indent={2}>
                ...
                <Expression
                  ...
                  onActivate={() => router.push(`/store${window.location.search}`)}
                >
                  builtInItemsPanelStore
                </Expression>
                <Punctuation>&#125;</Punctuation>
