...
const installSource = `bun add panel`

const stylesheetSource = `import 'panel/style.css'`

const storeSource = `import { createTweakerPanelStore } from 'panel'
      ...
      <div className="mx-auto grid max-w-5xl gap-8 p-4 sm:p-6 lg:grid-cols-[13rem_minmax(0,1fr)] lg:gap-10 lg:p-8">
        ...
        <article className="min-w-0">
          ...
          <div className="divide-y divide-white/10">
            ...
            >
              <p>
                Add <Code>panel</Code> with your project&apos;s package manager. Import the package
                stylesheet once from your application entry point.
              </p>
              <CodeBlock language="bash" label="Install panel" source={installSource} />
              <CodeBlock
                language="typescript"
          ...
          <section className="border-t border-white/10 pt-9" id="usage-agent-checklist">
            ...
            <ol className="mt-5 grid gap-3 text-sm leading-6 text-zinc-300">
              <ConstraintItem>
                Import only from <Code>panel</Code> unless a low-level advanced API is explicitly
                required.
              </ConstraintItem>
              <ConstraintItem>
