...
export const tweakerThemeAttribute = 'data-tweaker-theme'
export const tweakerDefaultTheme = 'dark'

export const tweakerLayerTokens = {
  panelBase: 1000,
} as const

export const tweakerGeometryTokens = {
...
export const tweakerMotionTokens = {
  dragElastic: 0.01,
