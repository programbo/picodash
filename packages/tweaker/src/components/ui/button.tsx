...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center gap-(--tweaker-space-1-5) rounded-tweaker-control border border-transparent bg-clip-padding text-(length:--tweaker-font-size-xl) leading-(--tweaker-line-normal) font-(--tweaker-font-medium) whitespace-nowrap text-tweaker-text transition-colors duration-(--tweaker-duration-fast) outline-none select-none focus-visible:ring-2 focus-visible:ring-tweaker-focus focus-visible:ring-offset-1 focus-visible:ring-offset-tweaker-canvas data-focus-visible:ring-2 data-focus-visible:ring-tweaker-focus data-focus-visible:ring-offset-1 data-focus-visible:ring-offset-tweaker-canvas data-disabled:pointer-events-none data-disabled:opacity-(--tweaker-opacity-disabled) data-pressed:not-aria-[haspopup]:translate-y-px aria-invalid:border-tweaker-danger aria-invalid:ring-2 aria-invalid:ring-tweaker-danger/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-(--tweaker-icon-sm)",
  {
    variants: {
      variant: {
