...
import type { PicodashStore } from './picodash-provider.js'
import type { PicodashPanelPlacement } from './picodash-panel-types.js'
...
export function resolveFloatingCornerLayout(
  ...
  fallbackPlacement?: PicodashPanelPlacement,
