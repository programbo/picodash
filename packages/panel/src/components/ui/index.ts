...
export type TooltipProps = React.ComponentProps<typeof import('./tooltip.js').Tooltip>
export type TooltipTriggerProps = React.ComponentProps<typeof import('./tooltip.js').TooltipTrigger>
