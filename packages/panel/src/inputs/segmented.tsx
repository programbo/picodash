              ...
              {options.map((option, index) => {
                ...
                return (
                  <ToggleGroupItem
                    ...
                    className={cn(
                      'inline-flex h-(--picodash-control-height-xs) min-w-(--picodash-control-height-sm) items-center justify-center gap-(--picodash-space-1) border-l border-picodash-control px-(--picodash-space-2) text-(length:--picodash-font-size-md) leading-(--picodash-line-none) font-(--picodash-font-medium) text-picodash-muted outline-none transition-colors duration-(--picodash-duration-fast) first:border-l-0 data-hovered:bg-picodash-surface-muted data-hovered:text-picodash-text data-focus-visible:relative data-focus-visible:z-(--picodash-layer-raised) data-focus-visible:ring-2 data-focus-visible:ring-picodash-focus data-selected:bg-picodash-accent data-selected:text-picodash-accent-text data-disabled:pointer-events-none data-disabled:opacity-(--picodash-opacity-disabled-soft)',
                    )}
