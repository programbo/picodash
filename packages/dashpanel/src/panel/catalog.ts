...
const catalogReferencePaths = {
  '@picodash/dashpanel': '/docs/reference/dashlets',
  '@picodash/dashlist/dashlet': '/docs/reference/dashlet-components',
  '@picodash/dashpanel/ui': '/docs/reference/ui',
...
const builtInEntries: PicodashCatalogEntry[] = [
  entry({
    ...
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-text'),
  ...
  entry({
    ...
    variants: [],
    theme: { semanticTokens: controlThemeTokens },
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-number'),
    recipeIds: ['basic-control'],
  }),
  entry({
    id: 'built-in.slider',
    ...
    variants: [],
    theme: { semanticTokens: controlThemeTokens },
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-slider'),
    recipeIds: ['basic-control'],
  }),
  entry({
    id: 'built-in.switch',
    ...
    variants: [],
    theme: { semanticTokens: controlThemeTokens },
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-switch'),
    recipeIds: ['basic-control'],
  }),
  entry({
    id: 'built-in.select',
    ...
    variants: [],
    theme: { semanticTokens: controlThemeTokens },
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-select'),
  ...
  entry({
    ...
    theme: { semanticTokens: controlThemeTokens },
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-segmented'),
    recipeIds: ['choice-control'],
  }),
  entry({
    ...
    variants: [],
    theme: { semanticTokens: controlThemeTokens },
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-vector-3'),
  ...
  entry({
    ...
    variants: [],
    theme: { semanticTokens: controlThemeTokens },
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-range'),
    recipeIds: ['spatial-control'],
  }),
  entry({
    id: 'built-in.xy-pad',
    ...
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-xy-pad'),
    recipeIds: ['spatial-control'],
  }),
  entry({
    ...
    variants: [],
    theme: { semanticTokens: controlThemeTokens },
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-alignment'),
    recipeIds: ['spatial-control'],
  }),
  entry({
    ...
    theme: { semanticTokens: controlThemeTokens },
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-matrix-2d'),
    recipeIds: ['choice-control'],
  }),
  entry({
    ...
    variants: [],
    theme: { semanticTokens: [...controlThemeTokens, '--picodash-color-well'] },
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-dropzone'),
  ...
  entry({
    ...
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-media-preview'),
    recipeIds: ['media-inspector'],
  }),
  entry({
    id: 'built-in.display',
    ...
    variants: [],
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-display'),
  ...
  entry({
    ...
    variants: [],
    theme: { semanticTokens: dataThemeTokens },
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-sparkline'),
  ...
  entry({
    ...
    theme: { semanticTokens: dataThemeTokens },
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-chart'),
  ...
  entry({
    ...
    referenceAnchor: referenceAnchor('@picodash/dashpanel', 'picodash-gradient'),
    recipeIds: ['spatial-control'],
  }),
]
...
const dashletEntries: PicodashCatalogEntry[] = dashletDefinitions.map(
  ([exportName, category, valueKinds, allowedParents, recommendedParents, variants, recipeId]) =>
    entry({
      ...
      exportName,
      entrypoint: '@picodash/dashlist/dashlet',
      category,
