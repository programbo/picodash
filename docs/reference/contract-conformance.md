...
| STORE-RUNTIME | Declarative leases and transient product channels | [packages/store/tests/integration.test.ts](../../packages/store/tests/integration.test.ts)                                                                                         | Partial   | provider/entity/relationship leases verified; binding/transient channels remain outstanding                                          |
...
| STORE-LIFE    | Destroy and use-after-destroy                     | [packages/store/tests/scope-metadata.test.ts](../../packages/store/tests/scope-metadata.test.ts)                                                                                   | Planned   | scope destruction is verified; root lifecycle/use-after-destroy remains excluded                                                     |
