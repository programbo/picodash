...
| STORE-META    | Built-in records and lazy durable scope state     | [packages/store/tests/metadata.test.ts](../../packages/store/tests/metadata.test.ts) (record codec); lifecycle tests remain planned                                               | Partial   | [metadata.test.ts](../../packages/store/tests/metadata.test.ts) — immutable record validation, placement unions, duplicate map rejection, JSON round-trip/determinism |
