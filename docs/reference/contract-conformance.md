...
| STORE-DIAG    | Operational diagnostics and runtime inspection    | [packages/store/tests/diagnostics.test.ts](../../packages/store/tests/diagnostics.test.ts) and [diagnostics.types.test.ts](../../packages/store/tests/diagnostics.types.test.ts)             | Partial   | core namespace, subscriber aggregation/recovery, privacy, reentrancy, and teardown verified; adapter/persistence/inspectRuntime remain planned          |
...
| STORE-LIFE    | Destroy and use-after-destroy                     | [packages/store/tests/root-lifecycle.test.ts](../../packages/store/tests/root-lifecycle.test.ts), [packages/store/tests/integration.test.ts](../../packages/store/tests/integration.test.ts) | Partial   | root teardown, lease refusal, use-after-destroy, detached survivors, and diagnostics teardown verified; adapter/persistence capabilities remain pending |
